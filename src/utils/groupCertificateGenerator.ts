 ...
 * Generates certificates for the Pinata group-based system
 */
export class GroupCertificateGenerator {
  private static instance: GroupCertificateGenerator;

  private constructor() {}

  public static getInstance(): GroupCertificateGenerator {
    if (!GroupCertificateGenerator.instance) {
      GroupCertificateGenerator.instance = new GroupCertificateGenerator();
    }
    return GroupCertificateGenerator.instance;
  }

  /**
   * Generate harvest certificate (initial certificate)
   */
  public async generateHarvestCertificate(
    batchData: {
      batchId: string;
      farmerName: string;
      cropType: string;
   ...
   */
  public async generatePurchaseCertificate(
    groupId: string,
    purchaseData: {
      batchId: string;
      from: string;
...
export const groupCertificateGenerator = GroupCertificateGenerator.getInstance();
